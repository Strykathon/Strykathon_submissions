...
from lib.datasets import CityscapesDataset, MapillaryDataset, CityscapesUtils
...
import yaml
MIXED_PRECISION = True  # or False if you don't want to use mixed precision training
CACHE = False  # Set to True or False based on your preference
